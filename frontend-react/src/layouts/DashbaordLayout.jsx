...
<div className="flex gap-4 items-center">
  <select 
    ...
    className="h-10 px-3 rounded-xl bg-slate-800/40 text-slate-300 border border-slate-700/50 hover:border-slate-600 focus:outline-none focus:ring-1 focus:ring-blue-500/50 transition text-sm cursor-pointer"
  >
    <option value="English" className="bg-slate-900 text-slate-300">English</option>
    <option value="Spanish" className="bg-slate-900 text-slate-300">Spanish</option>
  </select>
